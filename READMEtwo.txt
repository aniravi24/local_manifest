...
2. Edit .repo/manifest.xml. Find the projects audio-caf, display-caf, and media-caf. Remove those lines. (This is now needed thanks to a repo tool update which doesn't allow duplicate paths set in your xml's.)
